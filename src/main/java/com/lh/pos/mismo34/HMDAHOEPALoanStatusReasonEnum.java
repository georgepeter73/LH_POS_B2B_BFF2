...
/**
 * A value from a MISMO prescribed list that specifies the reason behind the HOEPA disposition for a HMDA covered loan that you originated or purchased that is a high-cost mortgage under the Home Ownership and Equity Protection Act of 1994 (HOEPA), as implemented in Regulation Z Section 1026.32.
 *
 * <p>Java class for HMDA_HOEPALoanStatusReasonEnum complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="HMDA_HOEPALoanStatusReasonEnum">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.mismo.org/residential/2009/schemas>HMDA_HOEPALoanStatusReasonBase">
...
@XmlType(name = "HMDA_HOEPALoanStatusReasonEnum", propOrder = {
    "value"
})
public class HMDAHOEPALoanStatusReasonEnum {

    @XmlValue
    protected HMDAHOEPALoanStatusReasonBase value;
     ...
     * @return
     *     possible object is
     *     {@link HMDAHOEPALoanStatusReasonBase }
     *
     */
    public HMDAHOEPALoanStatusReasonBase getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(HMDAHOEPALoanStatusReasonBase value) {
        this.value = value;
    }
