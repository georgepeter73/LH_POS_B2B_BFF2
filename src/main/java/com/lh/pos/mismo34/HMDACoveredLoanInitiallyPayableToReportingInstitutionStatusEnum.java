...
/**
 * A value from a MISMO prescribed list that specifies whether a loan, or in the case of an application that is required to be reported to HMDA, would have been initially payable to the reporting entity.
 *
 * <p>Java class for HMDACoveredLoanInitiallyPayableToReportingInstitutionStatusEnum complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="HMDACoveredLoanInitiallyPayableToReportingInstitutionStatusEnum">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.mismo.org/residential/2009/schemas>HMDACoveredLoanInitiallyPayableToReportingInstitutionStatusBase">
...
@XmlType(name = "HMDACoveredLoanInitiallyPayableToReportingInstitutionStatusEnum", propOrder = {
    "value"
})
public class HMDACoveredLoanInitiallyPayableToReportingInstitutionStatusEnum {

    @XmlValue
    protected HMDACoveredLoanInitiallyPayableToReportingInstitutionStatusBase value;
     ...
     * @return
     *     possible object is
     *     {@link HMDACoveredLoanInitiallyPayableToReportingInstitutionStatusBase }
     *
     */
    public HMDACoveredLoanInitiallyPayableToReportingInstitutionStatusBase getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(HMDACoveredLoanInitiallyPayableToReportingInstitutionStatusBase value) {
        this.value = value;
    }
