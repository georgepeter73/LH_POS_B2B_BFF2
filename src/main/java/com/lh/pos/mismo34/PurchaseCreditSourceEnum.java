...
/**
 * Specifies the party contributing credits to the transaction exclusive of the mortgage financing. This may be collected on the URLA in Section VII (Details of Transaction - Other Credits - Explain)
 *
 * <p>Java class for PurchaseCreditSourceEnum complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="PurchaseCreditSourceEnum">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.mismo.org/residential/2009/schemas>PurchaseCreditSourceBase">
...
@XmlType(name = "PurchaseCreditSourceEnum", propOrder = {
    "value"
})
public class PurchaseCreditSourceEnum {

    @XmlValue
    protected PurchaseCreditSourceBase value;
    ...
    /**
     * Term: Purchase Credit Source Type Definition: Specifies the party contributing credits to the transaction exclusive of the mortgage financing. This may be collected on the URLA in Section VII (Details of Transaction - Other Credits - Explain)
     *
     * @return
     *     possible object is
     *     {@link PurchaseCreditSourceBase }
     *
     */
    public PurchaseCreditSourceBase getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(PurchaseCreditSourceBase value) {
        this.value = value;
    }
