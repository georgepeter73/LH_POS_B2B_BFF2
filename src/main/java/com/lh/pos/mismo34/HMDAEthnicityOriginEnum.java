...
/**
 * A value from a MISMO prescribed list that represents the borrower's or interviewer's statement about the borrower's ethnicity origin as defined in the Home Mortgage Disclosure Act (HMDA).
 *
 * <p>Java class for HMDAEthnicityOriginEnum complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="HMDAEthnicityOriginEnum">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.mismo.org/residential/2009/schemas>HMDAEthnicityOriginBase">
...
@XmlType(name = "HMDAEthnicityOriginEnum", propOrder = {
    "value"
})
public class HMDAEthnicityOriginEnum {

    @XmlValue
    protected HMDAEthnicityOriginBase value;
    ...
    /**
     * Term: HMDA Ethnicity Origin Type Definition: A value from a MISMO prescribed list that represents the borrower's or interviewer's statement about the borrower's ethnicity origin as defined in the Home Mortgage Disclosure Act (HMDA).
     *
     * @return
     *     possible object is
     *     {@link HMDAEthnicityOriginBase }
     *
     */
    public HMDAEthnicityOriginBase getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(HMDAEthnicityOriginBase value) {
        this.value = value;
    }
