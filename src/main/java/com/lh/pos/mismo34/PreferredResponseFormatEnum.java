 ...
 *
 * <p>Java class for PreferredResponseFormatEnum complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="PreferredResponseFormatEnum">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.mismo.org/residential/2009/schemas>PreferredResponseFormatBase">
...
@XmlType(name = "PreferredResponseFormatEnum", propOrder = {
    "value"
})
public class PreferredResponseFormatEnum {

    @XmlValue
    protected PreferredResponseFormatBase value;
    ...
    /**
     * Term: Preferred Response Format Type Definition: Designate the response format type for the service or product being requested. The format options are Text, PCL, PDF, XML or Other. If Other is selected, enter the format in Response Format Other.
     *
     * @return
     *     possible object is
     *     {@link PreferredResponseFormatBase }
     *
     */
    public PreferredResponseFormatBase getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(PreferredResponseFormatBase value) {
        this.value = value;
    }
