...
/**
 * A value from a MISMO prescribed list that represents the borrower's or interviewer's statement about the borrower's race as defined in the Home Mortgage Disclosure Act. Up to 5 Race Types may be included per borrower.
 *
 * <p>Java class for HMDARaceEnum complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="HMDARaceEnum">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.mismo.org/residential/2009/schemas>HMDARaceBase">
...
@XmlType(name = "HMDARaceEnum", propOrder = {
    "value"
})
public class HMDARaceEnum {

    @XmlValue
    protected HMDARaceBase value;
     ...
     *
     */
    public void setValue(HMDARaceBase value) {
        this.value = value;
    }
