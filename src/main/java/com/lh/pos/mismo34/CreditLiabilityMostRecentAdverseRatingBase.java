...
/**
 * <p>Java class for CreditLiabilityMostRecentAdverseRatingBase.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="CreditLiabilityMostRecentAdverseRatingBase">
 ...
 *
 */
@XmlType(name = "CreditLiabilityMostRecentAdverseRatingBase")
@XmlEnum
public enum CreditLiabilityMostRecentAdverseRatingBase {
    ...
    CreditLiabilityMostRecentAdverseRatingBase(String v) {
        value = v;
    }
    ...
    public static CreditLiabilityMostRecentAdverseRatingBase fromValue(String v) {
        for (CreditLiabilityMostRecentAdverseRatingBase c: CreditLiabilityMostRecentAdverseRatingBase.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
