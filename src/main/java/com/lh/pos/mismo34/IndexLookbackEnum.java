...
/**
 * Renamed from "Loan Index Lookback Type" in Version 2.x
 *
 * <p>Java class for IndexLookbackEnum complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="IndexLookbackEnum">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.mismo.org/residential/2009/schemas>IndexLookbackBase">
...
@XmlType(name = "IndexLookbackEnum", propOrder = {
    "value"
})
public class IndexLookbackEnum {

    @XmlValue
    protected IndexLookbackBase value;
    ...
    /**
     * Term: Index Lookback Type Definition: Specifies the point in time prior to the effective date of the payment adjustment at which date the effective value of the published index is taken to compute the new payment.
     *
     * @return
     *     possible object is
     *     {@link IndexLookbackBase }
     *
     */
    public IndexLookbackBase getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(IndexLookbackBase value) {
        this.value = value;
    }
