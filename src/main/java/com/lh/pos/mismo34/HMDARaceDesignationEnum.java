...
/**
 * A value from a MISMO prescribed list that represents the borrower's or interviewer's statement about the borrower's race designation as defined in the Home Mortgage Disclosure Act.
 *
 * <p>Java class for HMDARaceDesignationEnum complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="HMDARaceDesignationEnum">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.mismo.org/residential/2009/schemas>HMDARaceDesignationBase">
...
@XmlType(name = "HMDARaceDesignationEnum", propOrder = {
    "value"
})
public class HMDARaceDesignationEnum {

    @XmlValue
    protected HMDARaceDesignationBase value;
    ...
    /**
     * Term: HMDA Race Designation Type Definition: A value from a MISMO prescribed list that represents the borrower's or interviewer's statement about the borrower's race designation as defined in the Home Mortgage Disclosure Act.
     *
     * @return
     *     possible object is
     *     {@link HMDARaceDesignationBase }
     *
     */
    public HMDARaceDesignationBase getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(HMDARaceDesignationBase value) {
        this.value = value;
    }
