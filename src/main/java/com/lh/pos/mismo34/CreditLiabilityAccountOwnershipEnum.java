 ...
 *
 * <p>Java class for CreditLiabilityAccountOwnershipEnum complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="CreditLiabilityAccountOwnershipEnum">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.mismo.org/residential/2009/schemas>CreditLiabilityAccountOwnershipBase">
...
@XmlType(name = "CreditLiabilityAccountOwnershipEnum", propOrder = {
    "value"
})
public class CreditLiabilityAccountOwnershipEnum {

    @XmlValue
    protected CreditLiabilityAccountOwnershipBase value;
    ...
    /**
     * Term: Credit Liability Account Ownership Type Definition: Describes the ownership relation of the borrower(s) to the liability account (i.e. are they solely responsible, jointly responsible, a co-signer on the account, etc.)
     *
     * @return
     *     possible object is
     *     {@link CreditLiabilityAccountOwnershipBase }
     *
     */
    public CreditLiabilityAccountOwnershipBase getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(CreditLiabilityAccountOwnershipBase value) {
        this.value = value;
    }
