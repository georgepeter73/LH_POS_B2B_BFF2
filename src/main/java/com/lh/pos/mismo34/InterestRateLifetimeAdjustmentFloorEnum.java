 ...
 *
 * <p>Java class for InterestRateLifetimeAdjustmentFloorEnum complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="InterestRateLifetimeAdjustmentFloorEnum">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.mismo.org/residential/2009/schemas>InterestRateLifetimeAdjustmentFloorBase">
...
@XmlType(name = "InterestRateLifetimeAdjustmentFloorEnum", propOrder = {
    "value"
})
public class InterestRateLifetimeAdjustmentFloorEnum {

    @XmlValue
    protected InterestRateLifetimeAdjustmentFloorBase value;
    ...
    /**
     * Term: Interest Rate Lifetime Adjustment Floor Type Definition: Describes if a lifetime floor exists for the specified plan and the method of calculating the floor. This field used in conjunction with the Maximum Decrease Rate.
     *
     * @return
     *     possible object is
     *     {@link InterestRateLifetimeAdjustmentFloorBase }
     *
     */
    public InterestRateLifetimeAdjustmentFloorBase getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(InterestRateLifetimeAdjustmentFloorBase value) {
        this.value = value;
    }
