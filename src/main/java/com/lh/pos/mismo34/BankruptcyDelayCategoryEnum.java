...
/**
 * A value from a MISMO prescribed list that represents a general grouping for activities that may create a delay in the actual bankruptcy process.
 *
 * <p>Java class for BankruptcyDelayCategoryEnum complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="BankruptcyDelayCategoryEnum">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.mismo.org/residential/2009/schemas>BankruptcyDelayCategoryBase">
...
@XmlType(name = "BankruptcyDelayCategoryEnum", propOrder = {
    "value"
})
public class BankruptcyDelayCategoryEnum {

    @XmlValue
    protected BankruptcyDelayCategoryBase value;
     ...
     * @return
     *     possible object is
     *     {@link BankruptcyDelayCategoryBase }
     *
     */
    public BankruptcyDelayCategoryBase getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(BankruptcyDelayCategoryBase value) {
        this.value = value;
    }
