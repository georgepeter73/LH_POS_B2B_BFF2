...
/**
 * A value from a MISMO prescribed list that represents the type of legal action that has been filed or threatened by one or more parties that may impact the servicer, investor, borrower or underlying obligation.
 *
 * <p>Java class for LitigationEnum complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="LitigationEnum">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.mismo.org/residential/2009/schemas>LitigationBase">
...
@XmlType(name = "LitigationEnum", propOrder = {
    "value"
})
public class LitigationEnum {

    @XmlValue
    protected LitigationBase value;
     ...
     *
     */
    public LitigationBase getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(LitigationBase value) {
        this.value = value;
    }
