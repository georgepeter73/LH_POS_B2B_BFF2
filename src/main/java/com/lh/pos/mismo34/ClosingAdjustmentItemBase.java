 ...
 *     &lt;enumeration value="LenderCredit"/>
 ...
 *     &lt;enumeration value="SatisfactionOfSubordinateLien"/>
 ...
 *     &lt;enumeration value="SubordinateFinancingProceeds"/>
 *     &lt;enumeration value="SweatEquity"/>
 *     &lt;enumeration value="TenantSecurityDeposit"/>
 *     &lt;enumeration value="TitlePremiumAdjustment"/>
...
public enum ClosingAdjustmentItemBase {
     ...
     *
     */
    @XmlEnumValue("LenderCredit")
    LENDER_CREDIT("LenderCredit"),
    @XmlEnumValue("Other")
    OTHER("Other"),
     ...
     *
     */
    @XmlEnumValue("SatisfactionOfSubordinateLien")
    SATISFACTION_OF_SUBORDINATE_LIEN("SatisfactionOfSubordinateLien"),
     ...
     *
     */
    @XmlEnumValue("SubordinateFinancingProceeds")
    SUBORDINATE_FINANCING_PROCEEDS("SubordinateFinancingProceeds"),
    ...
    /**
     * The difference between the TitleLendersCoveragePremium amount and the discounted lender's title policy premium amount when the lender's title policy premium is subject to a discount because an owner's title policy was purchased at the same time.
     *
     */
    @XmlEnumValue("TitlePremiumAdjustment")
    TITLE_PREMIUM_ADJUSTMENT("TitlePremiumAdjustment"),
