...
/**
 * The creation of a right or obligation that may be imposed or allowed on the property, is privately created and applied to an individual property. See ENCUMBRANCE for rights or obligations that affect property ownership and recorded in the local jurisdiction.
 *
 * <p>Java class for PrivatelyCreatedServitudeEnum complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="PrivatelyCreatedServitudeEnum">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.mismo.org/residential/2009/schemas>PrivatelyCreatedServitudeBase">
...
@XmlType(name = "PrivatelyCreatedServitudeEnum", propOrder = {
    "value"
})
public class PrivatelyCreatedServitudeEnum {

    @XmlValue
    protected PrivatelyCreatedServitudeBase value;
    ...
    /**
     * Term: Privately Created Servitude Type Definition: The creation of a right or obligation that may be imposed or allowed on the property, is privately created and applied to an individual property. See ENCUMBRANCE for rights or obligations that affect property ownership and recorded in the local jurisdiction.
     *
     * @return
     *     possible object is
     *     {@link PrivatelyCreatedServitudeBase }
     *
     */
    public PrivatelyCreatedServitudeBase getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(PrivatelyCreatedServitudeBase value) {
        this.value = value;
    }
