...
/**
 * <p>Java class for CreditLiabilityPriorAdverseRatingBase.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="CreditLiabilityPriorAdverseRatingBase">
 ...
 *
 */
@XmlType(name = "CreditLiabilityPriorAdverseRatingBase")
@XmlEnum
public enum CreditLiabilityPriorAdverseRatingBase {
    ...
    CreditLiabilityPriorAdverseRatingBase(String v) {
        value = v;
    }
    ...
    public static CreditLiabilityPriorAdverseRatingBase fromValue(String v) {
        for (CreditLiabilityPriorAdverseRatingBase c: CreditLiabilityPriorAdverseRatingBase.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
