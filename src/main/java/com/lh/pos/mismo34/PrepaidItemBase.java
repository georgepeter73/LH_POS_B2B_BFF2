...
public enum PrepaidItemBase {
    ...
    USDA_RURAL_DEVELOPMENT_GUARANTEE_FEE("USDARuralDevelopmentGuaranteeFee"),

    /**
     * In a loan guaranteed by the Department of Veterans’ Affairs (VA), the fee the veteran pays to help defray the costs of the VA home loan program.
     *
     */
    @XmlEnumValue("VAFundingFee")
    VA_FUNDING_FEE("VAFundingFee"),
