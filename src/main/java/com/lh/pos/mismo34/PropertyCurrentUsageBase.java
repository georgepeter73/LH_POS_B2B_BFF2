...
/**
 * <p>Java class for PropertyCurrentUsageBase.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="PropertyCurrentUsageBase">
 ...
 *
 */
@XmlType(name = "PropertyCurrentUsageBase")
@XmlEnum
public enum PropertyCurrentUsageBase {
    ...
    PropertyCurrentUsageBase(String v) {
        value = v;
    }
    ...
    public static PropertyCurrentUsageBase fromValue(String v) {
        for (PropertyCurrentUsageBase c: PropertyCurrentUsageBase.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
