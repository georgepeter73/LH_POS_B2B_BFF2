...
/**
 * Specifies the type of price adjustment that is made when comparing to sales and listings to value a property. Each type corresponds to a feature of the property. E.g. Condition, age, view, etc.
 *
 *
 * <p>Java class for ComparableAdjustmentEnum complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="ComparableAdjustmentEnum">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.mismo.org/residential/2009/schemas>ComparableAdjustmentBase">
...
@XmlType(name = "ComparableAdjustmentEnum", propOrder = {
    "value"
})
public class ComparableAdjustmentEnum {

    @XmlValue
    protected ComparableAdjustmentBase value;
    ...
    /**
     * Term: Comparable Adjustment Type Definition: Specifies the type of price adjustment that is made when comparing to sales and listings to value a property. Each type corresponds to a feature of the property. E.g. Condition, age, view, etc.
     *
     *
     * @return
     *     possible object is
     *     {@link ComparableAdjustmentBase }
     *
     */
    public ComparableAdjustmentBase getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(ComparableAdjustmentBase value) {
        this.value = value;
    }
