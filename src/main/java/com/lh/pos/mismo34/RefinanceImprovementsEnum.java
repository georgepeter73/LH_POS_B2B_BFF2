 ...
 *
 * <p>Java class for RefinanceImprovementsEnum complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="RefinanceImprovementsEnum">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.mismo.org/residential/2009/schemas>RefinanceImprovementsBase">
...
@XmlType(name = "RefinanceImprovementsEnum", propOrder = {
    "value"
})
public class RefinanceImprovementsEnum {

    @XmlValue
    protected RefinanceImprovementsBase value;
    ...
    /**
     * Term: Refinance Improvements Type Definition: Specifies whether the improvements associated with a refinance have been made to the property or if they are planned. Collected on the URLA in Section II (Refinance - Describe Improvements - Check Box.)
     *
     * @return
     *     possible object is
     *     {@link RefinanceImprovementsBase }
     *
     */
    public RefinanceImprovementsBase getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(RefinanceImprovementsBase value) {
        this.value = value;
    }
