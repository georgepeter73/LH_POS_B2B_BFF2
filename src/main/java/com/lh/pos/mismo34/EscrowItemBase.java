 ...
 *     &lt;enumeration value="ConstructionCompletionFunds"/>
...
public enum EscrowItemBase {
    ...
    @XmlEnumValue("CityBondTax")
    CITY_BOND_TAX("CityBondTax"),
     ...
     *
     */
    @XmlEnumValue("ConstructionCompletionFunds")
    CONSTRUCTION_COMPLETION_FUNDS("ConstructionCompletionFunds"),
