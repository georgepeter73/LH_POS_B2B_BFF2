 ...
 *
 * <p>Java class for PreferredResponseMethodEnum complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="PreferredResponseMethodEnum">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.mismo.org/residential/2009/schemas>PreferredResponseMethodBase">
...
@XmlType(name = "PreferredResponseMethodEnum", propOrder = {
    "value"
})
public class PreferredResponseMethodEnum {

    @XmlValue
    protected PreferredResponseMethodBase value;
    ...
    /**
     * Term: Preferred Response Method Type Definition: Specifies the method for delivering the service or product requested - Email, Fax, File, FTP, HTTP, etc. The destination information is listed in the Response Destination element.
     *
     * @return
     *     possible object is
     *     {@link PreferredResponseMethodBase }
     *
     */
    public PreferredResponseMethodBase getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(PreferredResponseMethodBase value) {
        this.value = value;
    }
