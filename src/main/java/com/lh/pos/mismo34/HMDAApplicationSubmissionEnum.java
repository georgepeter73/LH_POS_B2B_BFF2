...
/**
 * A value from a MISMO prescribed list that specifies whether the applicant or borrower, on a HMDA covered loan or application, submitted the application directly to the reporting institution.
 *
 * <p>Java class for HMDAApplicationSubmissionEnum complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="HMDAApplicationSubmissionEnum">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.mismo.org/residential/2009/schemas>HMDAApplicationSubmissionBase">
...
@XmlType(name = "HMDAApplicationSubmissionEnum", propOrder = {
    "value"
})
public class HMDAApplicationSubmissionEnum {

    @XmlValue
    protected HMDAApplicationSubmissionBase value;
     ...
     * @return
     *     possible object is
     *     {@link HMDAApplicationSubmissionBase }
     *
     */
    public HMDAApplicationSubmissionBase getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(HMDAApplicationSubmissionBase value) {
        this.value = value;
    }
