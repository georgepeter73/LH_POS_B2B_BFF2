...
/**
 * <p>Java class for LoanDefaultLossPartyBase.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="LoanDefaultLossPartyBase">
 ...
 *
 */
@XmlType(name = "LoanDefaultLossPartyBase")
@XmlEnum
public enum LoanDefaultLossPartyBase {
    ...
    LoanDefaultLossPartyBase(String v) {
        value = v;
    }
    ...
    public static LoanDefaultLossPartyBase fromValue(String v) {
        for (LoanDefaultLossPartyBase c: LoanDefaultLossPartyBase.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
