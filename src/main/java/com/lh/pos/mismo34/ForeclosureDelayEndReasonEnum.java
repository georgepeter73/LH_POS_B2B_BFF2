...
/**
 * A value from a MISMO prescribed list that represents the reason an interruption in the established foreclosure timeline ended and the foreclosure process resumed.
 *
 * <p>Java class for ForeclosureDelayEndReasonEnum complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="ForeclosureDelayEndReasonEnum">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.mismo.org/residential/2009/schemas>ForeclosureDelayEndReasonBase">
...
@XmlType(name = "ForeclosureDelayEndReasonEnum", propOrder = {
    "value"
})
public class ForeclosureDelayEndReasonEnum {

    @XmlValue
    protected ForeclosureDelayEndReasonBase value;
     ...
     * @return
     *     possible object is
     *     {@link ForeclosureDelayEndReasonBase }
     *
     */
    public ForeclosureDelayEndReasonBase getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(ForeclosureDelayEndReasonBase value) {
        this.value = value;
    }
