...
/**
 * A value from a prescribed list that specifies the type of statement required to be disclosed to, or considered by, the borrower of certain information pertaining to loan program features, creditor policies, and requirements in or arising from the legal obligation or loan.
 *
 * <p>Java class for LoanConsiderationDisclosureStatementEnum complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="LoanConsiderationDisclosureStatementEnum">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.mismo.org/residential/2009/schemas>LoanConsiderationDisclosureStatementBase">
...
@XmlType(name = "LoanConsiderationDisclosureStatementEnum", propOrder = {
    "value"
})
public class LoanConsiderationDisclosureStatementEnum {

    @XmlValue
    protected LoanConsiderationDisclosureStatementBase value;
     ...
     * @return
     *     possible object is
     *     {@link LoanConsiderationDisclosureStatementBase }
     *
     */
    public LoanConsiderationDisclosureStatementBase getValue() {
        return value;
    }
     ...
     *
     */
    public void setValue(LoanConsiderationDisclosureStatementBase value) {
        this.value = value;
    }
